...
function Accordion ({coverImage, featuredMedia, title, slug, summary, designTools, devTools}) {
        ...
        <div onClick={() => setIsActive(!isActive)} className='project'>
            ...
            <div className={isActive ? 'accordion-content open' : 'accordion-content'}>
                ...
                <div className="button-arrow-small">
                    <Link to={`/projects/${slug}`} aria-label="View more information about this project">View Project
